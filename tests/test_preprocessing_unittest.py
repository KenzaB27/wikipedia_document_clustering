...
from utils.preprocessing import remove_html_tags, remove_special_characters, remove_accented_chars, expand_contractions
...
class Preprocessing(unittest.TestCase):
    ...
    def test_remove_accented_characters(self):
        """ Test that it can remove accented characters"""
    ...
    def test_expand_contractions(self):
        """Test that it expands contractions"""
        ...
        self.assertEqual(expand_contractions(text_with_contractions),
                         decontracted_text, "Sould be " + decontracted_text)

    def test_remove_special_characters(self):
        """Test that it remove special characters"""
